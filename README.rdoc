...
This example sends all input to an output.  If a note message is passing through, it will be transposed up an octave.  Output is also printed to the screen by passing in $stdout.
