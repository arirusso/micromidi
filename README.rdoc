...
That example does the following: 
...
Note that you can pass in as many inputs and outputs as you like, or {none at all}[http://github.com/arirusso/micromidi/blob/master/examples/midi_message_objects.rb].  If you wish to operate on certain devices specifically, open them in seperate blocks.
