...
Here is an example that outputs some MIDI messages to a {unimidi output}[http://github.com/arirusso/unimidi/blob/master/examples/select_a_device.rb].
...
Input works similarly. You can pass in as many inputs and outputs as you like
