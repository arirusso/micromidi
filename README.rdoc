...
This example sends all input to an output with the exception of note messages which will first be transposed up an octave.  Output is also printed to the console.
