...
In the interest of expressiveness, there are many permutations of each of these methods.  I recommend reading the rdoc for {MicroMIDI::Instructions::Input}[http://github.com/arirusso/micromidi/blob/master/lib/micromidi/instructions/input.rb] to get a handle on what's possible.
