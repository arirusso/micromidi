...
Currently handles constructing MIDI message objects and realtime IO.  Uses {unimidi}[http://github.com/arirusso/unimidi] for cross-platform compatibility using MRI or JRuby.
...
You can also "play" notes, sending both an on and off message automatically.  This will play C3 for a half a second. 
