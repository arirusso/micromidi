...
The following are basic examples that use Unimidi inputs and outputs.  ({see an example here that explains selecting an output...}[http://github.com/arirusso/unimidi/blob/master/examples/select_a_device.rb])
...
Finally, this is the same example redone using shorthand aliases
...
I've written up a few posts explaining each of these concepts in greater detail:
