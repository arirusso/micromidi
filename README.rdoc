...
This example sends all messages from <em>@input</em> to <em>@output</em> with the exception of notes.  When a note is received, it raises the note's value by an octave before sending it to <em>@output</em>.
