...
There are many permutations of each of these methods, giving input handling with Micromidi a lot of flexibility.  I recommend reading the rdoc for {MicroMIDI::Instructions::Input}[http://github.com/arirusso/micromidi/blob/master/lib/micromidi/instructions/input.rb] to get a handle on what's possible.
