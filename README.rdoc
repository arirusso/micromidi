...
<em>Channel</em> and <em>velocity</em> have sticky values (0 and 100 by default, respectively).  Sticky values are used by any commands where their value is needed, unless they're overriden by passing in an explicit value to the command.
