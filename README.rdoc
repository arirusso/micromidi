...
In micromidi, Channel and velocity are sticky values.  When you open a micromidi block, those values default to 0 and 100, respectively.  These sticky values will be used by any commands that need them.  One can also pass a channel or velocity value explicitly to a command overriding the sticky value.
